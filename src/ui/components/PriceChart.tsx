...
export default function PriceChart({ snap, epoch, storm = false, seed, theme = 'dark' }: { snap: SimSnapshot | null; epoch: number; storm?: boolean; seed?: ChartSeed; theme?: Theme }) {
  ...
  // theme in deps: rebuild + re-seed picks up the new chrome palette
  }, [epoch, theme]);
  ...
  // epoch/theme in deps: chart is recreated on scenario or theme switch, so color must be reapplied
  }, [storm, epoch, theme]);
